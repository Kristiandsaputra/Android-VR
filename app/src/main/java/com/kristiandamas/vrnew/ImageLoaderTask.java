...
public class
ImageLoaderTask extends AsyncTask<AssetManager, Void, Bitmap> {
    ...
    public ImageLoaderTask(VrPanoramaView view, VrPanoramaView.Options viewOptions, String assetsName) {
